		...
		if form.is_valid():
			...
			if user is not None:
				if user.is_active:
					...
					elif user.Colaborador.tipo_acceso.tipo_acceso == "Administrador":
						return HttpResponseRedirect('/cp/')
					elif user.Colaborador.tipo_acceso.tipo_acceso == "Bodega":
						return HttpResponseRedirect('/bodega/')
					elif user.Colaborador.tipo_acceso.tipo_acceso == "Facturacion":
